...
<!-- TopNavBar -->
<nav class="fixed top-0 z-50 w-full border-b border-outline-variant/30 bg-surface/80 backdrop-blur-md transition-all duration-300">
	<div class="flex justify-between items-center max-w-container-max mx-auto h-16 px-gutter">
		...
		<div class="hidden items-center gap-stack-lg md:flex" aria-label="メインナビゲーション">
