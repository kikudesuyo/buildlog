...
test('verify tagging and filtering logic and capture screenshots', async ({ page }) => {
	...
	await page.fill('textarea[placeholder="物語を書き始めましょう..."]', 'これはタグ機能のE2Eテストです。');
	...
	// スクリーンショット撮影
	await page.screenshot({ path: 'static/screenshots/tags-filter.png', fullPage: true });
