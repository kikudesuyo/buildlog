...
func NewRouter() http.Handler {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Get("/diaries", handleFunc(v1.HandleGetDiary_List))
		...
		r.Get("/techs", handleFunc(v1.HandleGetTech_List))
		r.Post("/admin/tech/qiita/sync", handleFunc(v1.HandleSyncQiitaArticle_List))
		...
		r.Get("/trash", handleFunc(v1.HandleGetDeletedPost_List))
		r.Put("/trash/{id}/restore", handleFunc(v1.HandleRestorePost))
		r.Get("/apps", handleFunc(v1.HandleGetApp_List))
		...
		r.Get("/posts/{id}/comments", handleFunc(v1.HandleGetComment_List))
