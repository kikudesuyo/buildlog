...
func HandleGetTechList(r *http.Request, requestData map[string]interface{}) (http.Handler, error) {
	techList, err := service.ListTechs(r.Context(), service.DatabaseFromContext(r.Context()), r.URL.Query().Get("all") == "true", getClientIP(r))
	if err != nil {
		return nil, err
	}
...
func HandleGetTech(r *http.Request, requestData map[string]interface{}) (http.Handler, error) {
	...
	tech, err := service.GetTechByID(r.Context(), service.DatabaseFromContext(r.Context()), id, getClientIP(r))
	if err != nil {
		return nil, err
	}
...
func HandleCreateTech(r *http.Request, requestData map[string]interface{}) (http.Handler, error) {
	...
	resp, err := service.CreateTech(r.Context(), service.DatabaseFromContext(r.Context()), req)
	if err != nil {
		return nil, err
	}
...
func HandleUpdateTech(r *http.Request, requestData map[string]interface{}) (http.Handler, error) {
	...
	resp, err := service.UpdateTech(r.Context(), service.DatabaseFromContext(r.Context()), id, req)
	if err != nil {
		return nil, err
	}
	return entity.NewObjectResponse(resp), nil
...
func HandleDeleteTech(r *http.Request, requestData map[string]interface{}) (http.Handler, error) {
	...
	if err := service.DeleteTech(r.Context(), service.DatabaseFromContext(r.Context()), id); err != nil {
		return nil, err
	}
