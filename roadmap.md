...
- [x] #34 [syntax highlighting](https://github.com/kikudesuyo/buildlog/issues/34) — コードブロック表示・言語ラベル・コピー操作・ダークテーマを実装。svelte-check/eslint/prettier通過（既存warningのみ）
- [ ] #56 [syntax highlighting for technology articles](https://github.com/kikudesuyo/buildlog/issues/56) — #34と重複確認後、必要な差分のみ統合
- [ ] #62 [アーキテクチャ修正](https://github.com/kikudesuyo/buildlog/issues/62) — handler/service/routesの責務整理
- [ ] #61 [Go命名修正](https://github.com/kikudesuyo/buildlog/issues/61) — 命名規約と既存コードの整合
- [ ] #5 [認可の設定](https://github.com/kikudesuyo/buildlog/issues/5) — 公開投稿権限といいね/コメント権限の整理

### Phase 1: 公開コンテンツ配信

- [ ] #35 [RSS feed](https://github.com/kikudesuyo/buildlog/issues/35) — RSS/Atom生成とalternate link
